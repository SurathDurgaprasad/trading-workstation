...
| **ML (triple-barrier baseline)** | Does a supervised ML classifier (logistic regression, triple-barrier labeling) beat the deterministic baseline? | `data/ml_research/` feature/label store | REJECTED — "no evidence of economic edge" | [`PHASE_1_REPORT.md`](research/PHASE_1_REPORT.md) | CLOSED |
