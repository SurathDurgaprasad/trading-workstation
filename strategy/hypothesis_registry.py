    ...
    return (
        ...
        HypothesisRecord(
            ...
            evidence=(
                ...
                "risk/execution design. "
                "ADDENDUM (year-stability follow-up, SECONDARY DESCRIPTIVE, same frozen entry/universe, "
                "development period broken down by calendar year at h5/h10/h20): CONFIRMED, not merely "
                "plausible -- 2020 is a clear, dramatic outlier. At every horizon 2020 shows a CI-decisive "
                "NEGATIVE mean (h10: -5.30%, CI=[-6.02%,-4.58%]), an order of magnitude different from every "
                "neighboring year (h10: 2017 +2.18%, 2019 +0.07%, 2021 +2.85%, 2022 +1.10%, 2023 +1.65%, all "
                "CI-decisive positive or not decisive; only 2018 shows a real, much milder exception at h10, "
                "-0.53%). This resolves the open question: the shared Q1/Q3 development-period anomaly is "
                "explained by 2020 specifically, not a broad feature of the whole window. Economically "
                "coherent and it SHARPENS Q4's own finding: March 2020 was a textbook systemic, broad-market "
                "crash -- precisely the MARKET_DRIVEN weakness type Q4 already found less reliable (unstable, "
                "sign-reversing between splits) relative to RELATIVE_WEAKNESS (CI-decisive positive in all "
                "three splits). During a genuine systemic panic the usual mean-reversion mechanism plausibly "
                "fails or reverses -- a real, disclosed regime-dependence, now made concrete rather than "
                "merely inferred. Not acted on (2020 is not excluded from any measurement -- that would be a "
                "post-hoc, results-driven edit this project's own discipline forbids); reported as an "
                "explanatory finding only. Full writeup in "
